...
list1[i].getElementsByTagName("a")[0].style.background = "red"; // Change the background to red
list1[i].getElementsByTagName("a")[0].innerHTML += "<img src='https://media.discordapp.net/attachments/483662916449468418/484371509058600980/border-48.png'>" //Add the warning
}
